...
<div class="colaborador-view">
    ...
    <p>
        <?= Html::a('Update', ['update', 'rutColaborador' => $model->rutColaborador, 'rutEmpresa' => $model->rutEmpresa, 'idCargo' => $model->idCargo, 'idRol' => $model->idRol, 'idArea' => $model->idArea], ['class' => 'btn btn-raised btn-primary']) ?>
