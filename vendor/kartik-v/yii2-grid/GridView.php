...
class GridView extends \yii\grid\GridView
{
     ...
     * Boolean Icons
     */
    const ICON_ACTIVE = '<span class="glyphicon glyphicon-certificate text-success"></span>';
    const ICON_INACTIVE = '<span class="glyphicon glyphicon-certificate text-danger"></span>';
    const ICON_MEDIUM = '<span class="glyphicon glyphicon-certificate text-warning"></span>';

    /**
     * Expand Row Icons
     */
    const ICON_EXPAND = '<span class="glyphicon glyphicon-chevron-down"></span>Ver más';
    const ICON_COLLAPSE = '<span class="glyphicon glyphicon-collapse-down"></span>Ver Menos';
...
HTML;
    ...
    public function renderExport()
    {
        ...
        return ButtonDropdown::widget(
            [
                'label' => $title,
                'dropdown' => ['items' => $items, 'encodeLabels' => true, 'options' => $menuOptions],
                'options' => $options,
    ...
    protected function initToggleData()
    {
        ...
        if (!empty($icon)) {
            $label = "<i class='glyphicon glyphicon-{$icon}'></i> " ."LISTAR TODO";
        }
