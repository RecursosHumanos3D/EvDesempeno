...
class ActionColumns extends Column
{
    ...
    protected function initDefaultButtons()
    {
        if (!isset($this->buttons['view'])) {
            ...
            return Html::button('actualizar', ['value' => Url::to('index.php?r=area/view&id='.$key), 'class' => 'btn btn-success', 'id' => 'modalButton']);
            };
        }
        if (!isset($this->buttons['update'])) {
            ...
            return Html::button('actualizar', ['value' => Url::to('index.php?r=area/update&id='.$key), 'class' => 'btn btn-success', 'id' => 'modalButton']);
            };
        }
